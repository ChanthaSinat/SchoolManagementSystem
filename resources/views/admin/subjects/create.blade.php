...
<div class="max-w-4xl mx-auto space-y-6">
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-black text-slate-900">Add Subject</h1>
            <p class="text-slate-500 text-sm font-medium mt-1">Create a subject and map it to year level and semester.</p>
        </div>
        ...
        <form method="POST" action="{{ route('admin.subjects.store') }}" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input id="code" name="code" type="text" value="{{ old('code') }}" placeholder="e.g. MATH101" class="w-full px-4 py-2.5 rounded-xl border border-slate-200 bg-white/60 focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-400 outline-none text-sm">
