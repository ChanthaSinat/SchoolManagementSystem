    ...
    <div class="h-screen flex overflow-hidden">
        ...
        <aside class="w-64 bg-slate-800 flex flex-col p-6 shrink-0 shadow-xl">
            ...
            <nav class="flex-1 space-y-1.5">
                ...
                <a href="{{ route('teacher.dashboard') }}" class="flex items-center w-full px-4 py-3.5 rounded-xl text-slate-300 hover:bg-slate-700/80 hover:text-white font-semibold text-sm transition-colors">
