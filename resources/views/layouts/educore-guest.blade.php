...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>EduCore — {{ $title ?? config('app.name', 'System') }}</title>
    ...
    <body class="font-sans text-gray-900 antialiased bg-gray-50/50 min-h-screen relative overflow-x-hidden selection:bg-indigo-500 selection:text-white">
        ...
        <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 pb-12 px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="mb-8 transform hover:scale-105 transition-transform duration-300 mt-6 sm:mt-0">
            ...
            <div class="w-full sm:max-w-lg px-8 py-10 bg-white/70 backdrop-blur-xl shadow-[0_8px_30px_rgb(0,0,0,0.08)] border border-white overflow-hidden sm:rounded-3xl relative">
                <!-- Inner decoration -->
